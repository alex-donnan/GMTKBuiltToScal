...
if (mouse_check_button(mb_left) && LAYER3_MOVE == self) {
	...
	var mouse_dir = point_direction(room_width - 128, 128, GUI_MOUSE_X, GUI_MOUSE_Y);
	x = room_width - 128 + lengthdir_x(156, mouse_dir);
	y = 128 + lengthdir_y(156, mouse_dir);
